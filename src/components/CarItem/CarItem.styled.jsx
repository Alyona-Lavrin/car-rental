...
export const Container = styled.li`
  ...
  @media screen and (${p => p.theme.mq.tablet}) {
    ${(p) =>
      p.isActive && 
      ` border: ${p.theme.borders.large} ${p.theme.colors.red}; `
    };  
  };
...
export const BtnToggleFavorite = styled.div`
  ...
  ${p => p.isFavorite
    ...
    : `color: ${p.theme.colors.lighteRed};`
  }
...
export const BasicInfoText = styled.p`
  ...
  & > span {
    color: ${p => p.theme.colors.lighteRed};
  };
`;
...
export const Button = styled.button`
  ...
  &:hover {
    background-color: ${p => p.theme.colors.lighteRed};
    box-shadow: rgba(0, 0, 0, 0.5) 2px 8px 5px;
  };
`;
